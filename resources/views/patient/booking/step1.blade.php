...
<head>
    ...
    <title>Book Appointment - Step 1 - Clinica Bansil</title>
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-y-auto pb-20 md:pb-0">
        ...
        <main class="flex-1 p-4 md:p-8 space-y-6 max-w-6xl w-full mx-auto">
            ...
            <div class="bg-[#CBDCEB] p-6 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-[#003366] font-montserrat tracking-tight">Select Department</h1>
                    <p class="text-[#7794a3] text-xs md:text-sm mt-1 font-medium">
                        Step 1 of 5 – Department Selection
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6">
                ...
                <div class="mt-3 h-2 bg-slate-100 rounded-full overflow-hidden">
                    <div class="h-2 bg-[#1F6F8B] rounded-full transition-all duration-300" style="width: 20%"></div>
                </div>
            </div>

            <!-- FORM -->
            <form action="{{ route('patient.booking.step2') }}" method="GET">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 h-fit">
                        ...
                        <p class="text-xs text-slate-500 leading-relaxed">
                            Please choose the department that best matches your medical concern. This will determine which doctors are available in the next step.
                        </p>

                        <div class="mt-6 space-y-2 text-xs text-slate-500 border-t border-slate-100 pt-4">
                            <p class="flex items-center gap-2"><i class="fa-solid fa-circle-info text-[#1F6F8B]"></i> Required to continue booking</p>
                            <p class="flex items-center gap-2"><i class="fa-solid fa-user-doctor text-[#1F6F8B]"></i> Helps assign the correct doctor</p>
                            <p class="flex items-center gap-2"><i class="fa-solid fa-check text-[#1F6F8B]"></i> One department only</p>
                        </div>
                    </div>
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div
                                                class="w-12 h-12 rounded-full bg-slate-100
                                                       ...
                                                       peer-checked:bg-[#1F6F8B] transition-colors">
                                                <i class="fa-solid fa-hospital-user text-slate-400 text-lg peer-checked:text-white"></i>
                                            </div>

                                            <!-- TEXT -->
                                            <div>
                                                <h3 class="font-bold text-sm text-[#003366]">
                                                    {{ $department->name }}
                                                </h3>
                                                <p class="text-xs text-[#7794a3] font-medium mt-0.5">
                ...
                <div class="flex justify-between items-center mt-8 pt-6 border-t border-slate-200/60">
                    ...
                    <a href="{{ route('patient.dashboard') }}"
                       class="px-6 py-3 border border-slate-300 text-slate-600 font-bold text-xs uppercase tracking-wider rounded-xl hover:bg-slate-100 transition shadow-sm">
                        <i class="fa-solid fa-arrow-left mr-1"></i> Back
                    </a>

                    <button
                        type="submit"
                        class="px-8 py-3 bg-[#1F6F8B] hover:bg-[#18586e] text-white text-xs font-bold uppercase tracking-wider rounded-xl shadow-md transition active:scale-[0.98]">
                        Continue to Doctor <i class="fa-solid fa-arrow-right ml-1"></i>
                    </button>
